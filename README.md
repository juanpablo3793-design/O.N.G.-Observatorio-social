...
<head>
    ...
    <title>O.N.G. Colectivo Social Nacional – Sistema de Censo Territorial</title>
    <style>
<!-- Conector oficial de Supabase para JavaScript -->
<script src="https://unpkg.com/@supabase/supabase-js@2"></script>
        ...
        /* Estilo específico para campo numérico de edad */
        #edad {
        ...
        @media (max-width: 768px) {
            ...
            /* Tabs en móvil apilados verticalmente */
            .tabs {
            ...
            /* TÍTULOS DE MÓDULOS - REDUCIDOS PARA MÓVIL */
            .module-title {
            ...
            /* Barra de progreso - ajustar para móvil */
            .progress-container {
            ...
            /* Layout de campos en fila (para cédula/edad) */
            ...
            /* Comunas del mapa - hacer más legibles en móvil */
            .comuna-css {
                font-size: 9px !important;
                font-weight: 600;
                padding: 2px;
            ...
            /* Ajustar posiciones de comunas para móvil */
            ...
            .comuna-css[style*="San Simón"] { top: 28% !important; left: 60% !important; width: 26% !important; height: 14% !important; }
            .comuna-css[style*="Piedra Pintada"] { top: 42% !important; left: 35% !important; width: 32% !important; height: 14% !important; }
            .comuna-css[style*="Jordán"] { top: 30% !important; left: 10% !important; width: 28% !important; height: 17% !important; }
            ...
            .comuna-css[style*="Simón Bolívar"] { top: 62% !important; left: 45% !important; width: 22% !important; height: 14% !important; }
            .comuna-css[style*="Picaleña Mirolindo"] { top: 42% !important; left: 70% !important; width: 30% !important; height: 14% !important; }
            ...
            .comuna-css[style*="Boquerón"] { top: 58% !important; left: 70% !important; width: 28% !important; height: 16% !important; }
            
            /* Tooltip del mapa - ajustar para móvil */
            .map-tooltip {
            ...
            /* Tabla de administración - hacer scrollable */
            .data-table {
                display: block;
                overflow-x: auto;
                white-space: nowrap;
...
<body>
    <header>
        ...
        <h1>Plataforma Integral de Gestión Social</h1>
    </header>

    <div class="container">
        <!-- SISTEMA DE PESTAÑAS -->
        <div class="tabs">
            <button class="tab active" onclick="switchTab('censo')">📋 Nuevo Censo</button>
            <button class="tab" onclick="switchTab('mapa')">🗺️ Mapa Interactivo</button>
            <button class="tab" onclick="switchTab('admin')">📊 Administración</button>
        </div>

        <!-- PESTAÑA 1: FORMULARIO DE CENSO -->
        <div id="censo-tab" class="tab-content active">
            ...
            <div class="progress-container">
                ...
                <div class="progress-step" data-step="4">4<div class="progress-label">Ubicación</div></div>
            ...
            <div class="module active" id="m1">
                <h2 class="module-title">Módulo 1 – Datos Personales</h2>
                ...
                <div class="conditional-field" id="madreCabezaField">
                    <label>¿Es madre cabeza de hogar? <span class="required">*</span></label>
            ...
            <div class="module" id="m2">
                <h2 class="module-title">Módulo 2 – Contacto</h2>
                
                <label>Teléfono <span class="required">*</span></label>
                <input id="telefono" placeholder="Ej: 3001234567">
                
                <label>Dirección de vivienda</label>
                <input id="direccion" placeholder="Calle, carrera, número">
            ...
            <div class="module" id="m3">
                <h2 class="module-title">Módulo 3 – Actividad</h2>
                ...
                <!-- CAMPO CONDICIONAL: SUBCATEGORÍA DE TRABAJO INFORMAL -->
                <div class="conditional-field" id="subcategoriaTrabajoField">
                    <label>Subcategoría de trabajo informal <span class="required">*</span></label>
                ...
                <label>Detalle de la ocupación</label>
            ...
            <div class="module" id="m4">
                <h2 class="module-title">Módulo 4 – Ubicación</h2>
            ...
            <div class="module" id="m5">
                <h2 class="module-title">Módulo 5 – Legal</h2>
                
                <label>¿Ha sido vulnerado en sus derechos?</label>
                <select id="derechos">
                    <option value="">Seleccione</option>
                ...
                <label>Relación con institución</label>
                <select id="relacionInstitucion">
                    <option value="">Seleccione</option>
                    <option value="ninguna">Ninguna</option>
                    <option value="policia">Policía</option>
                    <option value="funcionario_alcaldia">Funcionario de alcaldía</option>
            ...
            <div class="success-message" id="successMessage">
                ...
                <p>Su código de censo es:</p>
                <div class="codigo-censo" id="codigoCenso"></div>
                <p>Guarde este código para futuras referencias.</p>
            </div>
        </div>

        <!-- PESTAÑA 2: MAPA INTERACTIVO -->
        <div id="mapa-tab" class="tab-content">
            <h2 class="module-title">🗺️ Mapa Interactivo Territorial</h2>
        ...
        <div id="admin-tab" class="tab-content">
            ...
            <div style="margin:20px 0;">
                <input type="text" id="searchInput" placeholder="🔍 Buscar por cédula, nombre o código..." 
...
const supabaseUrl = sb_publishable_ONFpGOUZqBQmflrdYFENrg_9ryOqaDD
const supabaseAnonKey = sb_secret_ZKOIYqyCX80Q2b4vu0RnQw_zwcXCGT9
// Crea el cliente para usar en toda la app
const supabase = window.supabase.createClient(supabaseUrl, supabaseAnonKey);
        
        // ============================================
        // CORRECCIÓN CRÍTICA: NORMALIZAR NOMBRES DE COMUNAS
        // ============================================
        ...
        const comunasUnificadas = {
            ...
            "Picaleña Mirolindo": "Picaleña Mirolindo",
            "Estadio": "Estadio",
            "Ferias": "Ferias",
        ...
        const barriosPorComuna = {
            ...
            "Calambeo": ["20 de Julio", "7 de Agosto", "Alaska", "Ancon", "Belén", "Belencito", "Centenario", "Centro pan de Azúcar", "Clarita Botero", "La Aurora", "La Paz", "La Sofía", "La Trinidad", "Malavar", "Paraíso", "San Diego", "Santa Barbara", "Santa Cruz", "VI Brigada", "Viña de Clambeo", "Villa Adriana"],
            "San Simón": ["Antonio Nariño", "Belalcázar", "Calambeo", "Carmenza Rocha", "El Carmen", "Fenalco", "Gaitán parte alta", "INEM", "La esperanza", "La Granja", "La Acacias", "San simón parte alta", "Villa llusión", "Villa Pinzón", "Villa Valentina", "Viveros"],
            "Piedra Pintada": ["Alfonso López", "Calarcá", "Cambulos", "Caracolí", "Castilla", "Gaitán", "Jacaranda", "Jesús María Córdoba", "José maría córdoba pate baja", "Limonar", "Limonar V sector", "Onzaga", "Piedra pintada", "Pijao", "Restrepo", "Rincón de piedra pintada", "San Carlos", "San Luis", "Sorrento", "Toscana", "Triunfo", "Villa Marlen I", "Villa Marlen II", "Villa Teresa"],
            "Jordán": ["4 Etapa del Jordán", "6 Etapa del Jordán", "7 Etapa del Jordán", "8 Etapa del Jordán", "9 Etapa del Jordán", "Andalicia", "Arboleda margaritas", "Arkacentro", "Arkamonica", "Arrayanes", "Calatayud", "Conj Res La Alemania", "Cordobita", "El Edén", "La campiña", "La Ladera", "Las Margaritas", "Las orquídeas", "Macadamia", "Multifamiliares el Jordán", "Multifamiliares Las Margaritas", "Prados del Norte", "Rincón de la Campiña", "San jacinto", "Torre Ladera", "Urb Aymara I", "Urb Aymara II", "Rincon de las Margaritas", "Urb Los Ocobos", "Urb Milenio I y II", "Urb Yacaira", "Urb Parrales"],
            "Vergel": ["Agua viva", "Altos de san francisco", "Balcones del vergel", "Bosques del vergel", "Brisas de Pedregal", "Cañaveral I", "Cañaveral II", "Camino de juan pablo II", "camino de san Francisco", "Camino del Vergel", "Condómino Ronda del Vergel", "Condómino tierra alta", "Conjunto cerrado Ambala", "Conjunto cerrado los Balsos", "El Mirador", "El Triunfo", "Estancia del vergel", "Fuente de Los Rosales", "Fuente de Los Rosales II", "La balsa", "La Esperanza", "La Gaviota", "Las Delicias", "Loa Alpes", "Loa Ángeles", "Los ciruelos", "Los Mandarinos", "Monte Madero", "Monte verde del Vergel", "Palma del Vergel", "Paseo de san Francisco", "Plazas del Bosque", "Portal del Vergel", "Primavera de Entre Rio", "Reservas del Pedregal", "Rincón de San Francisco", "Rincón del Pedregal I", "Rincón del Pedregal II", "Rincón del Vergel", "San Antonio", "Tierra linda del Vergel", "Torre fuente de los Rosales", "Torres de la Calleja", "Urb Arkala I", "Urb Arkambuco I", "Colinas del Norte", "Urb Pedregal", "Urb Villa Patricia", "Urb Altos de Ambala", "Urb Altos del pedregal", "Urb Ambala", "Urb Antares I", "Urb Antares II", "Urb Arkala II", "Urb Chicala", "Urb Entre Ríos I", "Urb Entre Ríos II", "Urb Fuente de los Rosales I", "Urb Girasol", "Urb Ibagué 2000", "Urb Los Cambulos", "Urb Los Gualandayes", "Urb Villa Vanesa", "Villa Gloria"],
            "Salado": ["Alamos", "chico", "El Salado", "Hacienda el Recreo", "Los Musicos", "Mirador de Cantabria", "Modelia I", "Modelia II", "Nueva Bilbao", "Pedro Ignacio VillaMarin", "Rosales de Tailandia", "Santa Ana", "Sector los Alpes", "Timaka", "Urb Santa Coloma", "Urb Alameda", "Urb Carlos LLeras C", "Urb Ambikaima", "Urb Cantabria", "Urb Comfatolima", "Urb Diana Milaidy", "Urb El Dorado", "Urb El Limón", "Urb El Palmar", "Fuente del Salado", "Urb Fuente santa", "Urb La Cabaña", "Urb La Candelar", "Urb La Floresta", "Urb La victoria", "Urb Lady Diana", "Urb Los Lagos", "Urb Monte Carlos", "Urb Oviedo", "Urb Pacandé", "Urb Palma del Rio", "Urb Palo Grande", "Urb Portales del Norte", "Urb Praderas del Norte", "Urb Reservas de Cantabria", "Urb San Luis", "Urb San Luis Gonzaga", "Urb San Luis II", "Urb San Pablo", "Urb San Sebastián", "Urb Santa catalina I", "Urb Santa Mónica", "Urb Shaddai", "Urb Territorio de Paz", "Urb Villa Brasilia", "Urb Villa clara II", "Urb Villa Julieta", "Protecho", "Urb Quinta Avenida", "Urb Tolima Grande", "Urb Vasconia", "Urb Vasconia Reservado", "Urb Villa del Norte", "Urb Villa del Palmar", "Urb Villa del Sol", "Urb Villa esperanza", "Urb Villa Jardín", "Urb Villa la paz", "Urb Villa Magdalena", "Urb Villa Marcela", "Urb Villa Vicentina", "Cristales", "Yerbabuena"],
            "Simón Bolívar": ["Atolsure", "Caminos del Bosque", "Ciudadela Simón Bolívar I", "Ciudadela Simón Bolívar II", "Ciudadela Simón Bolívar III", "Conj Recid San Joaquín", "El Bunde I ,II y III", "Urb El bunde IV", "German Huertas", "Jardín I", "Jardín III", "Jardín parte baja", "Jardín Santander I, II y III", "Jardín Valparaíso", "La Cima I", "La Cima II", "Musicaria", "palermo", "portal del Jardín", "Reservas del Jardín", "Roberto Augusto Calderón", "San Gelato", "Topacio", "Tulio Varón", "Unidad Resid Carabineros", "Urb 2 de Julio", "Urb Agua Marina", "Urb Altos de Vasconia", "Urb Antonio María", "Urb Brisas de Vasconia", "Urb Buenaventura García", "Urb Ciudad Blanca", "Urb El Palmar I", "Urb El Palmar II", "Urb El Prado I", "Urb El Prado II", "Urb Jardín Antolsure", "Urb Jardín Avenida V", "Urb Jardín Chipalo I", "Urb Jardín Chipalo II", "Urb Jardín II", "Urb Jardín Porvenir", "Urb Jardín VI", "Urb Jardines del Campo", "Urb La Esmeralda", "Urb Las Acacias", "Urb Los Comuneros", "Urb Los Laureles", "Urb Los Pinos", "Urb Nueva Castilla", "Urb Nueva Colombia", "Urb Nuevo Armero", "Urb Nuevo Combeima", "Urb Nuevo Combeima II", "Urb Portal de Arkalá", "Versalles"],
            "Picaleña Mirolindo": ["Etapa II del Jordán", "Alfonso Uribe Badillo", "Altamira", "Aparco", "arboleda", "Arkaniza I", "Arkaniza II", "Arkaparaíso", "Bello Horizonte", "Bosque de la Alameda", "Carrenales", "Cond Las Palmeras", "Conj Resid Valparaíso", "El Tunal", "hacienda piedra pintada", "Jordán 3 Etapa", "Jordán 1 Etapa", "La Floresta", "Los Tunjos", "Picaleñita", "Picaleña", "portal de los Tunjos", "Reservas del Campestre", "San Francisco", "san remo", "Urb Bosque de Varsovia", "Urb Chaquen", "Urb Ciudad Luz", "Urb Comfenalco", "Urb Coopdiasam", "Urb Cutucumay", "Urb El poblado", "Urb Las Américas", "Urb Las flores", "Urb Los Remansos", "Urb Miraflores", "Urb nuevo horizonte", "Urb portal campestre", "Urb Praderas de santa Rita", "Urb Tahití", "Urb Varsovia", "Urb Villa Arkadia", "Urb Villa café", "Urb Villa de la Candelaria", "Urb Villa luz", "Urb Villa Yuli", "Valparaíso I", "Valparaíso II", "Valparaíso III", "Valparaíso IV", "Villa Carvajalita", "Villa del Pilar", "Villa María", "Villa Natalia"],
            "Estadio": ["Arkalena", "Bosques de santa Helena", "Boyacá", "Cádiz", "Casa Club", "Castellana", "Claret", "Departamental", "Federico Lleras", "Hipódromo", "La Francia", "Las palmas", "Laureles", "Macarena parte Alta", "Macarena", "Macarena parte Baja", "Magisterio", "Metaima parte Alta", "Metaima parte Baja", "monte alegre", "Nacional", "Naciones Unidas", "San Cayetano", "Santa Helena", "Santander"],
            "Ferias": ["12 de Octubre", "Alto de la Cruz", "América", "Arado", "Bosque Parte Alta", "Bosque parte baja", "refugio I", "refugio II", "Garzón", "Independiente", "La Isla", "La Martinica", "Las Brisas", "Las Ferias", "Libertad", "Los Mártires", "Peñón", "Popular", "Rodríguez Andrade", "san Vicente de Paúl", "Uribe Uribe", "Villa del río", "Villa María"],
            "Las Brisas": ["Andrés López de Galarza", "Avenida", "Colonias de Asprovi", "Galán", "Industrial", "Kennedy", "La Gaitana", "La pradera", "La Reforma", "Las Vegas", "Matallana", "Murillo Toro", "Ricaurte", "Rosa Badillo", "Santofimio", "Urb Arkaima", "Urb Divino Niño", "Urb terrazas del Tejar", "Venecia", "Villa Claudia", "Villa Luces", "Yuldaima"],
            "Boquerón": ["Albania", "Boquerón", "Cerro Granate", "Colinas I", "Colinas II", "Darío Echandía", "Granada", "Isla", "Jazmín", "La Unión", "Miramar", "San Isidro", "terrazas de Boquerón", "Villa Mery"]
        };
        ...
        // ============================================
        // FUNCIÓN PARA NORMALIZAR NOMBRES DE COMUNAS
        // ============================================
        ...
        // ============================================
        // FUNCIONES DEL SISTEMA (PESTAÑAS)
        // ============================================
        ...
        // Cargar barrios según comuna seleccionada
        ...
        // ============================================
        // FUNCIONES PARA AJUSTAR BARRA DE PROGRESO EN MÓVILES
        // ============================================
        ...
        // ============================================
        // NAVEGACIÓN ENTRE MÓDULOS DEL FORMULARIO
        // ============================================
        ...
        function showModule(n) {
            ...
            // Ocultar todos los módulos con transición suave
            ...
            // Mostrar módulo actual con animación
            ...
            // Hacer scroll suave al inicio del módulo en móviles
            if (window.innerWidth <= 768) {
                setTimeout(() => {
        ...
        function nextModule(n) {
            // Validaciones básicas por módulo
            let isValid = true;
            let errorMessage = '';
            ...
            if (n === 1) {
                ...
                if (!document.getElementById('cedula').value.trim()) {
                    isValid = false;
                    errorMessage = 'Cédula es obligatoria';
                }
                if (!document.getElementById('edad').value || document.getElementById('edad').value < 1) {
                    isValid = false;
                    errorMessage = 'Edad es obligatoria (mínimo 1 año)';
                }
                ...
                if (document.getElementById('genero').value === 'femenino' && 
                    ...
                    isValid = false;
                    errorMessage = 'Para género femenino, debe indicar si es madre cabeza de hogar';
                }
            }
        ...
        async function finalizarRegistro() {
            // Validar aceptación de tratamiento de datos
            ...
            // Si no está en la lista unificada, normalizarla
            ...
            / 1️⃣ INTENTAR GUARDAR EN LA BASE DE DATOS SUPABASE (PRIMERO)
const { data, error } = await supabase
    .from('registros_censo') // Nombre EXACTO de la tabla que creamos
    .insert([registro])      // Inserta el objeto con todos los datos

if (error) {
    console.error('❌ Error al guardar en Supabase:', error);
    alert('Hubo un problema técnico al guardar el registro. Por favor, intenta de nuevo.');
    return; // Si hay error, se detiene aquí y no muestra éxito.
}

// 2️⃣ (Opcional) También guardar localmente como respaldo/para estadísticas inmediatas
...
consecutivo++;
        ...
        // ============================================
        // MAPA INTERACTIVO (MAPA 1 - CSS) - CORREGIDO PARA MÓVIL
        // ============================================
        ...
        function inicializarMapaCSS() {
            ...
            // Definir posiciones diferentes para móvil y desktop
            const comunasMapa = esMovil ? [
                // Posiciones optimizadas para móvil (más grandes, menos superposición)
                ...
                { nombre: "San Simón", top: "28%", left: "60%", width: "26%", height: "14%", color: "#007BFF" },
                { nombre: "Piedra Pintada", top: "42%", left: "35%", width: "32%", height: "14%", color: "#0052B1" },
                { nombre: "Jordán", top: "30%", left: "10%", width: "28%", height: "17%", color: "#0066CC" },
                { nombre: "Vergel", top: "52%", left: "5%", width: "32%", height: "15%", color: "#007BFF" },
                { nombre: "Salado", top: "68%", left: "20%", width: "28%", height: "13%", color: "#0052B1" },
                { nombre: "Simón Bolívar", top: "62%", left: "45%", width: "22%", height: "14%", color: "#0066CC" },
                { nombre: "Picaleña Mirolindo", top: "42%", left: "70%", width: "30%", height: "14%", color: "#007BFF" },
                ...
                { nombre: "Boquerón", top: "58%", left: "70%", width: "28%", height: "16%", color: "#0052B1" }
            ] : [
                ...
                { nombre: "San Simón", top: "40%", left: "55%", width: "14%", height: "13%", color: "#007BFF" },
                { nombre: "Piedra Pintada", top: "50%", left: "40%", width: "16%", height: "14%", color: "#0052B1" },
                { nombre: "Jordán", top: "35%", left: "25%", width: "13%", height: "16%", color: "#0066CC" },
                { nombre: "Vergel", top: "55%", left: "20%", width: "15%", height: "15%", color: "#007BFF" },
                { nombre: "Salado", top: "70%", left: "30%", width: "14%", height: "12%", color: "#0052B1" },
                { nombre: "Simón Bolívar", top: "65%", left: "50%", width: "12%", height: "14%", color: "#0066CC" },
                { nombre: "Picaleña Mirolindo", top: "45%", left: "70%", width: "16%", height: "13%", color: "#007BFF" },
                ...
                { nombre: "Boquerón", top: "60%", left: "75%", width: "13%", height: "15%", color: "#0052B1" }
            ];
            ...
            comunasMapa.forEach(comuna => {
                ...
                // Eventos para tooltip y selección
        ...
        function mostrarTooltipMapa(event, nombreComuna) {
            ...
            tooltip.innerHTML = `
                ...
                <div>🏘️ <strong>Barrios:</strong> ${barrios}</div>
                <div>📋 <strong>Registros:</strong> ${registros}</div>
                <div>📈 <strong>Densidad:</strong> ${densidad} reg/barrio</div>
        ...
        function generarReporteComuna() {
            ...
            let reporte = `📊 REPORTE DE LA COMUNA: ${comunaNormalizada}\n\n`;
            reporte += `📅 Fecha de generación: ${new Date().toLocaleDateString('es-CO')}\n`;
            reporte += `📋 Total de registros: ${registros.length}\n`;
            reporte += `🏘️ Barrios en la comuna: ${barriosPorComuna[comunaNormalizada]?.length || 0}\n\n`;
            ...
            reporte += `👥 ESTADÍSTICAS DEMOGRÁFICAS:\n`;
            reporte += `• Hombres: ${hombres} (${((hombres/registros.length)*100).toFixed(1)}%)\n`;
            reporte += `• Mujeres: ${mujeres} (${((mujeres/registros.length)*100).toFixed(1)}%)\n`;
            reporte += `• Madres cabeza de hogar: ${registros.filter(r => r.madreCabeza === 'Sí').length}\n\n`;
            
            reporte += `💼 ESTADÍSTICAS LABORALES:\n`;
            reporte += `• Trabajo informal: ${informales} (${((informales/registros.length)*100).toFixed(1)}%)\n`;
            reporte += `• Trabajo formal: ${registros.filter(r => r.trabajo === 'Formal').length}\n`;
            reporte += `• Desempleados: ${registros.filter(r => r.trabajo === 'Desempleado').length}\n\n`;
            
            reporte += `🏠 VIVIENDA:\n`;
            reporte += `• Casa propia: ${registros.filter(r => r.casaPropia === 'Sí').length}\n`;
            reporte += `• En arriendo: ${registros.filter(r => r.tipoVivienda === 'arriendo').length}\n`;
            ...
            Object.entries(barriosConRegistros).forEach(([barrio, count]) => {
                reporte += `• ${barrio}: ${count} registro(s)\n`;
            });
            
            alert(reporte);
        }
        
        // Ver detalle completo de la comuna (ir a administración)
        function verDetalleComuna() {
            ...
            // Cambiar a pestaña de admin y filtrar
            switchTab('admin');
                ...
                tbody.innerHTML = `
                    <tr>
                        <td colspan="7" style="padding:20px; text-align:center; color:#666;">
                            No hay registros aún. Comienza capturando datos en la pestaña "Nuevo Censo".
                        </td>
                    </tr>
                `;
        ...
        // FUNCIÓN verDetalleRegistro ACTUALIZADA
        function verDetalleRegistro(id) {
            const registro = database.registros.find(r => r.id === id);
            if (!registro) return;
            
            let detalles = `📄 DETALLE COMPLETO DEL REGISTRO\n\n`;
            detalles += `📋 Código: ${registro.codigoCenso}\n`;
            detalles += `👤 Nombre: ${registro.nombre}\n`;
            detalles += `🆔 Cédula: ${registro.cedula}\n`;
            detalles += `🎂 Edad: ${registro.edad}\n`;
            detalles += `⚧️ Género: ${registro.genero}\n`;
            if (registro.madreCabeza) detalles += `👩‍👧‍👦 Madre cabeza de hogar: ${registro.madreCabeza}\n`;
            detalles += `📞 Teléfono: ${registro.telefono}\n`;
            detalles += `🏠 Dirección: ${registro.direccion}\n`;
            detalles += `🏡 Casa propia: ${registro.casaPropia}\n`;
            if (registro.tipoVivienda) detalles += `🏚️ Tipo de vivienda: ${registro.tipoVivienda}\n`;
            detalles += `💼 Trabajo: ${registro.trabajo}\n`;
            if (registro.subcategoriaTrabajo) detalles += `📊 Subcategoría: ${registro.subcategoriaTrabajo}\n`;
            detalles += `📝 Detalle: ${registro.detalleTrabajo}\n`;
            detalles += `🗺️ Comuna: ${registro.comuna}\n`;
            detalles += `🏘️ Barrio: ${registro.barrio}\n`;
            detalles += `⚖️ Derechos vulnerados: ${registro.derechos}\n`;
            detalles += `🏛️ Relación con institución: ${registro.relacionInstitucion}\n`;
            detalles += `📅 Fecha de registro: ${registro.fechaFormateada}\n\n`;
            detalles += `══════════════════════════════════════\n`;
            detalles += `¿Qué desea hacer con este registro?\n`;
            
            // Usar confirm con opciones personalizadas
            const opcion = confirm(detalles + "\nClick en ACEPTAR para volver a la lista, CANCELAR para permanecer aquí.");
            
            if (opcion) {
                // Si hace clic en Aceptar, simplemente volver (no hacer nada más)
                console.log('Volviendo a la lista de registros...');
            } else {
                // Si hace clic en Cancelar, mostrar opción para eliminar
        ...
        // NUEVA FUNCIÓN: Eliminar registro directamente desde la tabla
        function eliminarRegistroDirecto(id) {
            const registro = database.registros.find(r => r.id === id);
            if (!registro) return;
            
            if (confirm(`⚠️ ¿Está seguro de eliminar el registro?\n\nCódigo: ${registro.codigoCenso}\nNombre: ${registro.nombre}\nCédula: ${registro.cedula}\n\nEsta acción no se puede deshacer.`)) {
        ...
        // Función para exportar TODOS los registros a Excel con formato de tabla
        function exportarAExcel() {
            ...
            alert(`✅ Se exportaron ${database.registros.length} registros a Excel.\n\nEl archivo se descargará automáticamente.\n\n📌 IMPORTANTE: Al abrir en Excel, selecciona "Datos" → "Desde texto/CSV" y especifica el separador como "punto y coma (;)"`);
        }
        ...
        function exportarFiltradosExcel() {
            ...
            if (busqueda.trim() === '') {
                // Si no hay búsqueda, exportar todos
                registrosAExportar = database.registros;
            } else {
                // Filtrar según la búsqueda actual
            ...
            alert(`✅ Se exportaron ${registrosAExportar.length} registros a Excel.\n\nEl archivo se descargará automáticamente.\n\n📌 IMPORTANTE: Al abrir en Excel, selecciona "Datos" → "Desde texto/CSV" y especifica el separador como "punto y coma (;)"`);
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // SOLO CREAR DATOS DE PRUEBA SI NO HAY NINGÚN REGISTRO
            if (database.registros.length === 0 && localStorage.getItem('datosPruebaCreados') !== 'true') {
                ...
                for (let i = 1; i <= 5; i++) {
                    const registroPrueba = {
                        ...
                        madreCabeza: i % 2 === 0 ? 'Sí' : '',
                        telefono: `300123456${i}`,
                        direccion: `Calle Prueba ${i}, Ciudad`,
                        casaPropia: i % 3 === 0 ? 'Sí' : 'No',
                        tipoVivienda: i % 3 === 0 ? '' : 'arriendo',
                        trabajo: i % 2 === 0 ? 'Formal' : 'Informal',
                        subcategoriaTrabajo: i % 2 === 0 ? '' : 'vendedor',
                        detalleTrabajo: 'Ocupación de prueba para el sistema',
                        comuna: 'Picaleña Mirolindo',
                        barrio: barriosPorComuna['Picaleña Mirolindo'][i % barriosPorComuna['Picaleña Mirolindo'].length],
                        derechos: 'ninguno',
                ...
                guardarEnStorage();
                console.log(`✅ 5 registros de prueba creados (solo una vez)`);
            }
            
            console.log('✅ Sistema de Censo Territorial inicializado.');
            console.log(`📊 Registros totales: ${database.registros.length}`);
